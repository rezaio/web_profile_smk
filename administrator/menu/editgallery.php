...
<section class="content">
    <div class="row">
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <select class="form-control" name="id_tags">
                                <?php
                                $sql = mysqli_query($koneksi, "select * from tbl_tags");
                                while ($data = mysqli_fetch_array($sql)) {
                                    if ($data['id_tags'] == $gallery['id_tags']) echo "<option value='$data[id_tags]' selected> $data[judul_tags] </option>";
                                    else  echo "<option value='$data[id_tags]'> $data[judul_tags] </option>";
                                }
                                ?>
                            </select>
                        </div>
        ...
        if (isset($_POST['fsimpan'])) {
            ...
            $q = "UPDATE tbl_gallery SET gambar ='$gambar', judul='$judul', id_tags='$id_tags', tanggal='$tanggal' where id_gallery='$id'";
