                        ...
                        <tbody>
                            ...
                            while ($data = mysqli_fetch_array($sql)) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <center>
                                            <a onclick="return confirm('Anda yakin akan menghapusnya ?')" title="hapus" href="admin.php?page=hapusdownload&id_download=<?php echo $data['id_download']; ?>" class="btn-sm btn-danger"><i class="fa fa-trash-o"></i> Hapus</a>
                                            <a title="edit" href="admin.php?page=editdownload&id_download=<?php echo $data['id_download']; ?>" class="btn-sm btn-info"><i class="fa fa-edit"></i> Edit</a>
                                        </center>
                                    </td>
                                </tr>
                                </tfoot>
