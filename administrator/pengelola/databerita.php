                        ...
                        <tbody>
                            ...
                            while ($data = mysqli_fetch_array($sql)) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <center>
                                            <a onclick="return confirm('Anda yakin akan menghapusnya ?')" title="hapus" href="pengelola.php?page=hapusberita&id_berita=<?php echo $data['id_berita']; ?>" class="btn-sm btn-danger"><i class="fa fa-trash-o"></i> Hapus</a>
                                            <a title="edit" href="pengelola.php?page=editberita&id_berita=<?php echo $data['id_berita']; ?>" class="btn-sm btn-info"><i class="fa fa-edit"></i> Edit</a>
                                        </center>
                                    </td>
                                </tr>
                                </tfoot>
