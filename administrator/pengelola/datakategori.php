                ...
                <div class="table-responsive">
                    <table id="komarudin" class="table table-bordered table-hover">
                        ...
                        <tbody>
                            <?php
                            $no = 1;
                            $sql = mysqli_query($koneksi, "SELECT * FROM tbl_kategoriberita") or die(mysqli_error());
                            while ($data = mysqli_fetch_array($sql)) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <center>
                                            <a onclick="return confirm('Anda yakin akan menghapusnya ?')" title="hapus" href="pengelola.php?page=hapuskategori&id_kategori=<?php echo $data['id_kategori']; ?>" class="btn-sm btn-danger"><i class="fa fa-trash-o"></i> Hapus</a>
                                            <a title="edit" href="pengelola.php?page=editkategori&id_kategori=<?php echo $data['id_kategori']; ?>" class="btn-sm btn-info"><i class="fa fa-edit"></i> Edit</a>
                                        </center>
                                    </td>
                                </tr>
                                </tfoot>
